                        ...
                        <nav class="navbar navbar-expand-lg navbar-light bg-white flex-row border-bottom shadow">
                            <div class="container-fluid">
                                <a class="navbar-brand mx-lg-1 mr-0" href="<?= base_url() ?>">
                                    <img src="<?= base_url('assets') ?>/img/logo.png" width="40" alt="Logo" class="d-inline-block">
                                    <span>Diagnosa Anxiety Disorder (Gangguan Kecemasan)</span>
                                </a>
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <form action="<?= base_url('diagnosa/hasil') ?>" method="post" class="needs-validation" novalidate>
                                    ...
                                    <strong class="card-title">Ceklis Gejala yang dialami :</strong>
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <button class="btn btn-primary mr-auto" type="submit">Diagnosa</button>
                                        </div>
                                        <div class="col-auto">
