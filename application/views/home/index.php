				...
				<div class="col-lg-12">
					<nav class="navbar navbar-expand-lg">
						<a class="navbar-brand" href="#home">
							<img src="<?= base_url('assets') ?>/img/logo.png" width="70" alt="Logo" class="d-inline-block">
						</a>
				...
				<div class="col-lg-7">
					<div class="header-hero-content">
						<h5 class="hero-title wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.2s">
							<b>Expert System<br>
								Diagnosa<br>
								<span> Anxiety Disorders</span><br>
		...
		<div class="row justify-content-center">
			<div class="col-lg-9">
				<div class="about-title text-center wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.3s">
					<h3 class="title">
						<span><b>Apa itu?<br>Anxiety Disorders (Gangguan Kecemasan)</b>
						</span>
					</h3>
				</div>
			</div>
							...
							<div class="col-lg-12">
								<div class="single-service d-flex">
									<div class="service-content media-body">
										<h4 class="service-title">Anxiety disorder (Gangguan Kecemasan)</h4>
										<p class="text-justify">adalah sebuah gaangguan kesehatan mental yang ditandai dengan perasaan khawatir, cemas, atau takut yang cukup kuat dan tidak mampu terkontrol sehibgga berujung pada ketakutan tanpa sebab bukan sesuatu yang wajar.</p>
									</div>
