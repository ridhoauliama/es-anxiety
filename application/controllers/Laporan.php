...
class Laporan extends CI_Controller
{
  ...
  public function cetakLaporan()
  {
    ...
    $pdf->Cell(277, 5, 'Expert System - Diagnosa Anxiety Disorder Menggunakan Metode Theorema Bayes', 0, 1, 'C');
    $pdf->Cell(277, 5, 'Tamara Sekar Adhiva (2017021156)', 0, 1, 'C');

    $pdf->Image('assets/img/logo.png', 143.5, 155, 15, 15);
