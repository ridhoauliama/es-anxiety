...
class Konsultasi extends CI_Controller
{
  ...
  public function printHasil()
  {
    ...
    $pdf->Cell(277, 15, 'Expert System - Diagnosa Anxiety Disorder (Gangguan Kecemasan)', 1, 1, 'C');
    $pdf->Image('assets/img/logo.png', 10, 10, 15, 15);
    $pdf->Image('assets/img/logo.png', 267, 10, 15, 15);
    $pdf->Cell(277, 0, '', 1, 1, 'C');
    ...
    // $pdf->SetFont('Times', '', 10);
    $pdf->Cell(50, 5,  $hasil['nama_penyakit'] . ' (' . $hasil['kode_penyakit'] . ')', 0, 0, 'L');
    // $pdf->SetFont('Times', '', 10);
    $pdf->Cell(20, 5, 'dengan persentase keyakinan sebesar ' . str_pad(substr(($hasil['hasil_probabilitas'] * 100), 0, 5), 2, '0') . ' %', 0, 1, 'L');
    ...
    $pdf->SetFont('Times', 'B', 10);
    $pdf->SetY(150);
    $pdf->Cell(277, 10, 'Terimakasih telah menggunakan web aplikasi kami, semoga hasil konsultasi ini bisa membantu Anda', 0, 1, 'C');
    $pdf->Cell(277, 0, '~!! Peluk Hangat !!~', 0, 1, 'C');
